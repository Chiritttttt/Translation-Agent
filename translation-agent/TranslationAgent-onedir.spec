...
"""
TranslationAgent - PyInstaller ONEDIR spec
===========================================
Builds a directory-based distribution (EXE + _internal/ folder).
More reliable for complex apps, faster startup, easier to debug.
...
# ═══════════════════════════════════════════════════════════
# EXE (onedir — small launcher executable)
# ═══════════════════════════════════════════════════════════
exe = EXE(
    pyz,
    a.scripts,
    ...
    strip=False,
    upx=False,   # onedir: skip UPX (already separate files)
    console=False,
...
# ═══════════════════════════════════════════════════════════
# COLLECT (all dependencies into _internal/ directory)
# ═══════════════════════════════════════════════════════════
coll = COLLECT(
    exe,
    a.binaries,
